...
urlpatterns = [
    path("projects/<int:project_id>/tasks", task_list, name="project-tasks-no-slash"),
    path("projects/<int:project_id>/tasks/", task_list, name="project-tasks"),
    path("tasks/<int:pk>", task_detail, name="task-detail-no-slash"),
    path("tasks/<int:pk>/", task_detail, name="task-detail"),
    path("tasks/<int:task_id>/subtasks", subtask_list, name="task-subtasks-no-slash"),
    path("tasks/<int:task_id>/subtasks/", subtask_list, name="task-subtasks"),
    path("tasks/<int:task_id>/subtasks/<int:pk>", subtask_detail, name="task-subtask-detail-no-slash"),
    path("tasks/<int:task_id>/subtasks/<int:pk>/", subtask_detail, name="task-subtask-detail"),
    path("tasks/<int:task_id>/dependencies", dependency_list, name="task-dependencies-no-slash"),
    path("tasks/<int:task_id>/dependencies/", dependency_list, name="task-dependencies"),
    path("tasks/<int:task_id>/dependencies/<int:pk>", dependency_detail, name="task-dependency-detail-no-slash"),
