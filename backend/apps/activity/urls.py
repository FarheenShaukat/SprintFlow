...
urlpatterns = [
    path("projects/<int:project_id>/activity", ProjectActivityView.as_view(), name="project-activity-no-slash"),
    path("projects/<int:project_id>/activity/", ProjectActivityView.as_view(), name="project-activity"),
    path("tasks/<int:task_id>/activity", TaskActivityView.as_view(), name="task-activity-no-slash"),
